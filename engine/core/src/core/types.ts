import type { ExprVal, DimVal } from '@geostat/expr'
import type { DataSpec }        from '../config/section'

/**
 * Engine-level data-lookup ops — extend @geostat/expr ExprVal with data access.
...
/** Engine derive entry — pure @geostat/expr expression OR data-access op. */
 ...
 * Structural superset of @geostat/expr DeriveMap; adds DataLookupOp variants.
 */
