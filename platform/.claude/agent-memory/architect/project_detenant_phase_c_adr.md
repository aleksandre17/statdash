---
name: detenant-phase-c-adr
description: ADR-0028 (ADR-0026 Phase C) — de-tenant apps/geostat into a PURE generic SDUI runner; extract geostat raw data (facts/classifiers/displays) into uploadable provisioning-format bundle files under ops/seed-data/geostat/; two-stage preservation (SQL gold seed = stage1, pipeline upload = stage2); parity gate before any deletion
metadata:
  type: project
---
