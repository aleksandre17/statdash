...
//
//  Phase 8.1 split: chart interpretation moved out of @statdash/engine into
//  @statdash/charts. The registry was split BY PACKAGE rather than shared —
...
import type { DataRow, SectionContext, ChartType } from '@statdash/engine'
