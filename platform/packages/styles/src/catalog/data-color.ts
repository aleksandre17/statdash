...
export const DATA_COLOR_TOKENS: Record<string, TokenDescriptor> = {
  ...
  'chart-color.series6':  { group: 'chart-color', cssVar: 'var(--chart-color-6)',  value: '#a17d00',
    label: { ka: 'სერია 6',  en: 'Series 6'  }, description: { ka: 'მე-6 სერია — მდოგვისფერი.', en: 'Series 6 — mustard.' } },
  'chart-color.series7':  { group: 'chart-color', cssVar: 'var(--chart-color-7)',  value: '#2b8dac',
  ...
  'chart-color.series9':  { group: 'chart-color', cssVar: 'var(--chart-color-9)',  value: '#5a9518',
