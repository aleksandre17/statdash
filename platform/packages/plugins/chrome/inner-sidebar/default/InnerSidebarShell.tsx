...
export function InnerSidebarShell(): ReactNode {
  ...
  // Cell + panel: the outer div is the LAYOUT allocation (fixed rail width);
  // the aside is the visual panel that hover-expands OVER content as an overlay
  // (inner-sidebar.css) — layout never reflows on expansion.
  return (
