...
// Warm/suspense placeholder — mirrors the resolved slider's shape (tabs + a grid
// of cards) so the async warm (useFeaturedRows) has a stable, non-CLS fallback.
export const Skeleton: SkeletonFn = (_node, _ctx) => (
  <div className="featured-slider-skeleton">
    <div className="featured-slider-skeleton__tabs">
      {[0, 1, 2].map(i => <div key={i} className="skeleton-block featured-slider-skeleton__tab" />)}
    </div>
