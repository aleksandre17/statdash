import { evalExpr }               from '@geostat/expr'
import type { DimVal, ExprScope } from '@geostat/expr'
 ...
 * Data-lookup ops call interpretSpec; pure ExprVal entries delegate to @geostat/expr.
 */
