...
//
//  Labels are resolved from OBS_STATUS_LABELS in @geostat/engine — locale
//  strings live there (or in the app i18n catalog); this component is
//  locale-agnostic and app-agnostic.
//

import React                 from 'react'
import type { ObsStatus }    from '@geostat/engine'
import { OBS_STATUS_LABELS } from '@geostat/engine'
