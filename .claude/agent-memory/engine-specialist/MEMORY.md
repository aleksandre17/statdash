...
- [FetchScheduler coalescing](reference_fetch_scheduler_coalesce.md) — single-flight (0111) on ADR-048 queue; 0112: datasources adapter 100% routed; boot-2× residue = panel raw fetches + two-client cube-profile
