...
- [page-config schema-gen + panel i18n](project_page_config_schema_gen_and_panel_i18n.md) — gen:schema after node/projector schema edits; chrome-i18n {en,ka}+t()+useActiveLocales; ColorControl DTCG-themed
