...
**How to apply:** when the chart de-brand wave runs, treat CSS + JS apex fonts together; do not naively map `.donut-legend` to `--font-family-base` (regresses geostat). See [[semantic-token-spine]] for the color-axis analogue. Blueprint: `docs/architecture/proposals/DESIGN-styles-architecture.md` §3/§7.
