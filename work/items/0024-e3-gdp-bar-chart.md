...
---
**Goal** — Vertical bars, one per year across the window; y = GDP level (mln_gel), with a compact axis that no longer duplicates ticks.

**Implements** — SPEC §2 E3 + §3.

**Files / modules touched** — GDP/regional bar-chart config; no engine change once C1/C2 land.

**Dependencies** — 0016 (C1 — axis compact), 0017 (C2 — `query`/`growth` per-year warm).
