...
priority: P1
owner: —
implements: SPEC §4 (all fitness functions)
depends_on: ["0016", "0017", "0018", "0019", "0020", "0021"]
links:
...
**Dependencies** — each FF is authored WITH its capability item (0016–0021). This item verifies the suite is complete and wired as a blocking CI gate.
